			 ...
			 <a href="admindashboard" class="btn-linked btn-link-back mr-10"><i class="bi bi-arrow-left"></i> Back</a>
								...
								<div class="card-body">
									<h5 class="card-title">
										...
										<a href="addstate" class="btn btn-primary w-100" type="submit" fdprocessedid="ai49e">Add State</a><br>
								
								</div>
									
								<div class="card-body">
									<h5 class="card-title">
										List <span>State</span>
									</h5>
										<a href="liststate" class="btn btn-primary w-100" type="submit" fdprocessedid="ai49e">List State</a><br>
