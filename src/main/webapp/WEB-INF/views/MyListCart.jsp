                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="mylistcart" class="nav-item nav-link active"><i class="fas fa-shopping-cart"></i> Cart</a>
 ...
 <!-- Fruits Shop Start-->
        <div class="container-fluid fruite py-5">
            <div class="container py-5">
                    ...
                    <a href="product" class="btn btn-outline-secondary rounded-pill px-4 py-2" style="margin-left: 100px;margin-top: 50px;">
    <i class="fa fa-arrow-left me-2"></i> Add More Product
</a>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                          <c:forEach items="${listmycarts}" var="lmi">
                            <tr>
                                <th scope="row">
                                ...
                                <td>
                                    <div class="input-group quantity mt-4" style="width: 100px;">
                                        <div class="input-group-btn">
                                            <button class="btn btn-sm btn-minus rounded-circle bg-light border" fdprocessedid="t4kl2">
                                            <i class="fa fa-minus"></i>
                                            </button>
                                        </div>
                                        <input type="text" class="form-control form-control-sm text-center border-0" value="1" fdprocessedid="qfmeyn">
                                        <div class="input-group-btn">
                                            <button class="btn btn-sm btn-plus rounded-circle bg-light border" fdprocessedid="rz9scg">
