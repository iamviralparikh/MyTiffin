			 ...
			 <a href="admindashboard" class="btn-linked btn-link-back mr-10"><i class="bi bi-arrow-left"></i> Back</a>
								...
								<div class="card-body">
									<h5 class="card-title">
										...
										<a href="newproduct" class="btn btn-primary w-100" type="submit" fdprocessedid="ai49e">Add Product</a><br>
								
								</div>
									
								<div class="card-body">
									<h5 class="card-title">
										List <span>Product</span>
									</h5>
										<a href="listproduct" class="btn btn-primary w-100" type="submit" fdprocessedid="ai49e">List Product</a><br>
